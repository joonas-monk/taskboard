...
export default function Card({ card, onClick }: Props) {
  ...
  const isPipelineActive = ['QUEUED', 'PLANNING', 'EXECUTING', 'BUILDING', 'TESTING', 'DEPLOYING', 'AWAITING_APPROVAL', 'AWAITING_EXEC_REVIEW', 'TEST_FAILED'].includes(card.pipelineStatus)
